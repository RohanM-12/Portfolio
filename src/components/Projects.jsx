...
const Projects = () => {
  return (
    <section>
      <div className="flex justify-center items-center text-3xl font-mono font-bold text-white">
        <span>
          <Image
      ...
      <Link href={"https://github.com/RohanM-12"}>
        <div className="flex px-5 py-2 justify-center items-center font-semibold font-mono text-orange-500 text-xl drop-shadow-2xl">
          checkout more projects here <FaArrowAltCircleRight className="mx-2" />
        </div>
      </Link>
    </section>
  );
